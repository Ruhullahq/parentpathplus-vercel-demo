export const metadata = { title: "ParentPath+ Demo", description: "Vercel-hosted demo with live provider search" };
    ...
    <html lang="en">
      <body style={{fontFamily:'Inter, ui-sans-serif, system-ui', background:'#f9fafb', color:'#111827'}}>
        ...
        <footer style={{borderTop:'1px solid #e5e7eb', padding:'24px 0', marginTop:40, fontSize:14, color:'#6b7280'}}>
          <div style={{maxWidth:960, margin:'0 auto', padding:'0 16px'}}>© {new Date().getFullYear()} ParentPath+</div>
        </footer>
      </body>
    </html>
  );
