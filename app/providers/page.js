        ...
        {items.map(p => (
          <div key={p.id || p.npi || Math.random()} style={{background:'#fff', padding:16, borderRadius:12, boxShadow:'0 1px 2px rgba(0,0,0,0.05)'}}>
            <div style={{display:'flex', justifyContent:'space-between', alignItems:'flex-start', gap:8}}>
              ...
              <a href="/concierge" style={{border:'1px solid #e5e7eb', padding:'6px 10px', borderRadius:8}}>Request Concierge</a>
            </div>
            <div style={{marginTop:8, display:'flex', gap:8, flexWrap:'wrap'}}>
              ...
              <a href="/pricing" style={{background:'#000', color:'#fff', padding:'6px 10px', borderRadius:8}}>Upgrade to Plus</a>
            </div>
          </div>
        ))}
